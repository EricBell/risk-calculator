...
class QtFuturesTab(QtBaseView):
    ...
    def _setup_field_references(self) -> None:
        ...
        self.contract_symbol_entry = self.form_fields.get('contract_symbol')
        self.entry_price_entry = self.form_fields.get('entry_price')
        self.tick_value_entry = self.form_fields.get('tick_value')
        self.tick_size_entry = self.form_fields.get('tick_size')
        self.margin_requirement_entry = self.form_fields.get('margin_requirement')
        self.risk_percentage_entry = self.form_fields.get('risk_percentage')
        self.stop_loss_ticks_entry = self.form_fields.get('stop_loss_ticks')
        self.fixed_risk_amount_entry = self.form_fields.get('fixed_risk_amount')
        self.stop_loss_ticks_fixed_entry = self.form_fields.get('stop_loss_ticks_fixed')
