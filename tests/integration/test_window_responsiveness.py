...
class TestWindowResponsivenessIntegration:
    ...
    def test_window_resize_preserves_layout(self):
        ...
        assert controller.layout_is_preserved() is True
        assert controller.all_elements_visible() is True
    ...
    def test_minimum_size_constraint_enforcement(self):
        ...
        assert actual_width >= 800
        assert actual_height >= 600
    ...
    def test_responsive_layout_performance(self):
        ...
        assert resize_time < 16.67, f"Resize took {resize_time}ms, should be under 16.67ms for 60fps"